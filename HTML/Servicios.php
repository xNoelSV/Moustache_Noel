...
<body class="text-center" data-hasqtip="0">
    ...
    <div class="px-4 pt-5 my-5 text-center">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5 mt-5">
                <?php if (!isset($_SESSION['Nombre'])) { ?>
                    <a href="Login.php"><button type="button"
                            class="btn btn-secondary btn-lg px-4 me-sm-3">Reserva</button></a>
                <?php } else { ?>
                    <a href="Reserva1.php"><button type="button"
                            class="btn btn-secondary btn-lg px-4 me-sm-3">Reserva</button></a>
                <?php } ?>
        ...
        <div class="row align-items-center" style="margin-top: 7.5%; margin-left:15%; margin-right: 15%;">
            <div class="col-3">
                <svg id="izq" onclick="imgIzq()" xmlns="http://www.w3.org/2000/svg" width="50%" height="50%"
            ...
            <div class="col-6">
                <img src="../IMG/CarrousselServicios/1.jpg" class="img-fluid shadow-lg mb-5 rounded" id="imgCentral"
                    style="width: 100%; height: 75%; margin: 0 auto; float:left;" />
                <div id="thumbnails">
            ...
            <div class="col-3">
                <svg id="der" onclick="imgDer()" xmlns="http://www.w3.org/2000/svg" width="50%" height="50%"
